...
define(function(require, exports, module){
    ...
    var Scene=cc.Div.extend({
        tpl:require("./learntarget2_edit.html"),
        data:null,
        body:"body",
        ...
        initAnimate:function(){
            var the=this
            //默认设置
            var localdata=JSON.parse(cc.localStorage("target"))||[]
            ...
            $("#next a",the.context).on("click",function(){
                ...
                cc.localStorage("target",JSON.stringify(arr))
            })
        },
        //60秒重新发送
        ...
        getJsonp:function(){
            ...
            $.ajax({
                ...
                data:{
                    type:"jsonp",
                    id:taregrt_id||getQueryString("id")
                },
